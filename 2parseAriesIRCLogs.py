...
################################################################
# usage:
# > python3 2parseAriesIRCLogs.py <datasource_id><password> 
#
# example usage:
# > python3 2parseAriesIRCLogs.py 63307 password 
#
# purpose: 
...
if datasource_id and password:
    ...
    selectQuery="select datasource_id, comments \
        		...
        		and forge_id=%s"  
    cursor1.execute(selectQuery,(datasource_id,forgeID))
    ...
    for row in rows : 
        ...
        for line in log:
            ...
            if ((datasource_id) and (messageType != "")):
                insertQuery= "INSERT IGNORE INTO apache_aries_irc(datasource_id,\
                              line_num,\
                              full_line_text,\
                              line_message,\
                              date_of_entry,\
